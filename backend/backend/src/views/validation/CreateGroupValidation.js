// function CreateGroupValidation(values) {
//     let errors = {};
...
//       errors.g_a_commission = "Percentage should not be empty";
...
//         errors.g_amount_per_head = "Email should not be empty";
//       } else if (!number_pattern.test(values.g_amount_per_head)) {
//         errors.g_amount_per_head = "Invalid email format";
//       }
//       else {
//         errors.g_amount_per_head = "";
//       }

//     if (values.g_month ==="") {
//         errors.g_month = "Email should not be empty";
//       } else if (!number_pattern.test(values.g_month)) {
//         errors.g_month = "Invalid email format";
//       }
//       else {
//         errors.g_month = "";
//       }
