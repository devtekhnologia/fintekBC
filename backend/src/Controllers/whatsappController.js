...
const sendMessageWinnerInfo = async (req, res) => {
  ...
  try {
    ...
    for (let i = 0; i < mobileNumbers.length; i++) {
      const options = {
        method: "POST",
        url: "https://graph.facebook.com/v19.0/306082309265432/messages",
        headers: {
          Authorization: `Bearer EAAGZCJwDqMnwBO1YcUPknwqpSH2qAeyC3xUVZBrWJAypvxsihF1jxk9osf6fwKYfaDZAFZCdXGPTVQVvmAmFLnZBhnQAvNrhxxpPcn7PfbCseImMhWjRZAgQuqfZBrs7uc6i6vWdjwaQ5MdDyOh0eTDyAZAZCAlmVtApFgCZBQD4RQG72gm2bdW6lHxP8Q7l4OhpnxQuQbFEEWvazGl8DZAkwVVLcZBG6BYZD`,
...
const sendbcDate = async (req, res) => {
  ...
  try {
    ...
    const options = {
      ...
      url: "https://graph.facebook.com/v19.0/306082309265432/messages",
      headers: {
        Authorization: `Bearer EAAGZCJwDqMnwBO1YcUPknwqpSH2qAeyC3xUVZBrWJAypvxsihF1jxk9osf6fwKYfaDZAFZCdXGPTVQVvmAmFLnZBhnQAvNrhxxpPcn7PfbCseImMhWjRZAgQuqfZBrs7uc6i6vWdjwaQ5MdDyOh0eTDyAZAZCAlmVtApFgCZBQD4RQG72gm2bdW6lHxP8Q7l4OhpnxQuQbFEEWvazGl8DZAkwVVLcZBG6BYZD`, // Replace with your actual access token
        "Content-Type": "application/json",
      },
      json: true,
    };
