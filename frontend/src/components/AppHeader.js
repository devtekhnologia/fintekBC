...
// import { set } from "../views/store/uiSlice"; // Import the set action from the actions file
...
//   const sidebarShow = useSelector((state) => state.ui.sidebarShow); // Access state.ui for the slice
...
//         <CHeaderToggler
//           onClick={() => dispatch(set({ sidebarShow: !sidebarShow }))} // Use the set action from the slice
