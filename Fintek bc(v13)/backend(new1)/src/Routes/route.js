...
router.post("/updatename", SchemeController.updateaname);
...
router.get("/totalbalanceagency", ReportController.gettotalbalanceofagency);
...
router.post("/bcstatus", bcdateController.getbcstatus);
